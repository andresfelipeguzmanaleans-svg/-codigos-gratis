...
export default function MakeOffer({ allItems, user, listingId, onClose, onOfferCreated }: Props) {
    ...
    <div className="cl__overlay" onClick={onClose}>
      <div className="cl__modal" onClick={e => e.stopPropagation()}>
        <div className="cl__head">
          <h3 className="cl__title">Make Offer</h3>
        ...
        <div className="cl__sides">
          <div className="cl__side">
            <span className="cl__side-label" style={{ color: '#22d3ee' }}>Your Offer ({offerCount}/{SLOT_COUNT})</span>
          ...
          <div className="cl__side">
            <span className="cl__side-label" style={{ color: '#818cf8' }}>You Want ({requestCount}/{SLOT_COUNT})</span>
